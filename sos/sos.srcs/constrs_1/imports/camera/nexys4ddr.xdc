...
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { jbtx] }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
...
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { jdtx }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
