...
logic [63:0] sqrt_float64;
    ...
    sqrt_conversion convert(
        ...
        .s_axis_a_tvalid(valid_signal),                        //: IN STD_LOGIC;
        .s_axis_a_tready( ),                        //: OUT STD_LOGIC;
        .s_axis_a_tdata(squared_distance),            //: IN STD_LOGIC_VECTOR(31 DOWNTO 0);
        .m_axis_result_tvalid(sqrt_result_valid),    //: OUT STD_LOGIC;
        .m_axis_result_tready(1),                       //: IN STD_LOGIC;
        .m_axis_result_tdata(squared_distance_float64)       //: OUT STD_LOGIC_VECTOR(63 DOWNTO 0)
    );
    ...
    square_root my_sqrt(
        ...
        .s_axis_a_tready( ),                        //: OUT STD_LOGIC;
        .s_axis_a_tdata(squared_distance_float64),            //: IN STD_LOGIC_VECTOR(31 DOWNTO 0);
        .m_axis_result_tvalid(actual_sqrt_result_valid),    //: OUT STD_LOGIC;
        .m_axis_result_tready(1),                       //: IN STD_LOGIC;
        .m_axis_result_tdata(sqrt_float64)       //: OUT STD_LOGIC_VECTOR(63 DOWNTO 0)
     );
     ...
     floating_point_1 convertBack(
        ...
        .s_axis_a_tready( ),                        //: OUT STD_LOGIC;
        .s_axis_a_tdata(sqrt_float64),            //: IN STD_LOGIC_VECTOR(31 DOWNTO 0);
        .m_axis_result_tvalid(final_result_valid),    //: OUT STD_LOGIC;
        .m_axis_result_tready(1),                       //: IN STD_LOGIC;
        .m_axis_result_tdata(distance_output)       //: OUT STD_LOGIC_VECTOR(63 DOWNTO 0)
    );
